...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center overflow-hidden py-8 lg:py-16">
      {/* 3D Minimalist Ambient Grid Wave Engine Background */}
      <Minimal3DBackground />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 my-auto">
        {/* Main 2-Column Grid: Left Copy & Right 3D Computing Device */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          
          {/* =========================================================================
              LEFT COLUMN: High-End Hero Typography & CTAs
             ========================================================================= */}
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            {/* 3. Subtitle */}
            <p
              className={`font-normal text-base sm:text-lg max-w-xl leading-relaxed transition-colors duration-300 ${
            ...
            <div className="flex flex-wrap items-center gap-4 pt-1">
              <Link
                ...
                className="group py-4 px-8 rounded-full bg-gradient-to-r from-primary-600 via-primary-500 to-accent-purple text-white font-bold text-sm shadow-neon-blue hover:shadow-neon-purple transition-all duration-300 flex items-center space-x-3 hover:scale-105 border border-primary-400/40"
              >
              ...
              <Link
                href="/work"
                className={`py-4 px-7 rounded-full font-bold text-sm transition-all duration-300 flex items-center space-x-2.5 hover:scale-105 backdrop-blur-xl ${
                  isDark
          ...
          {/* =========================================================================
              RIGHT COLUMN: 3D Sci-Fi Computing Device with Moving Graphs & Core
             ========================================================================= */}
        ...
        <div id="clients" className="mt-14 pt-6 border-t border-white/5">
          <p
